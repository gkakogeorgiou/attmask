...
"""
Mostly copy-paste from torchvision references or other public repos like DETR, DINO and iBOT:
...
class MultiCropWrapper(nn.Module):
    ...
    def forward(self, x, mask=None, return_backbone_feat=False, return_attention = False,
                **kwargs):
        # convert to list
